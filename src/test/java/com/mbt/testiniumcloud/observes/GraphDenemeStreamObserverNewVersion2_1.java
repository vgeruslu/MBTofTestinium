...
public class GraphDenemeStreamObserverNewVersion2_1 implements Observer {
    ...
    public GraphDenemeStreamObserverNewVersion2_1(Class startClass, List<Context> contextList, boolean isEdgeTextVisibility, boolean alwaysOnTop) {
    ...
    protected static void createMultiTab(List<Context> contextList){
        ...
        for (int i=0; i < contextList.size() ; i++) {
            ...
            //panel.add(viewPanel);
            tabbedPane.addTab(modelName, null, viewPanel, modelName);
