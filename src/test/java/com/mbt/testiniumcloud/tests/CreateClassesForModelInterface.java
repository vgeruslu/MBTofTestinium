...
public class CreateClassesForModelInterface {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String modelClassFolderName = "org.graphwalker";
        System.out.println(osName);
        slash = osName.equals("WINDOWS") ? "\\" : "/";

        String modelImpClass = "// Generated by GraphWalker (http://www.graphwalker.org)\n" +
                "package org.graphwalker;\n" +
                "import org.graphwalker.java.annotation.Model;\n" +
                "import org.graphwalker.java.annotation.Vertex;\n" +
                "import org.graphwalker.java.annotation.Edge;\n" +
                "\n" +
                "@Model(file = \"org/graphwalker/%s\")\n" +
                "public interface %s {\n";
        ...
        for (File file: files) {
            ...
            System.out.println("modelsJsonFileName: " + fileName);
                ...
                for (int i = 1; i < (modelCount+1); i++) {
                    ...
                    for (String elementName: modelMapInfo.getElementSet()) {
                        ...
                        methods.append(String.format(modelMethod
                                , elementName.startsWith("vertices_") ? "Vertex" : "Edge"
                                , elementName.startsWith("vertices_") ? elementName
                                        .replaceFirst("vertices_","") : elementName
                                        .replaceFirst("edges_","")));
                    }

                    String classInfo = String.format(modelImpClass, fileName, modelName)
                            + methods + closeClass;
                    String fileLocation = location + modelClassFolderName.replace(".", slash) + slash + modelName + ".java";

                    modelClassNameList.add(modelName);
