...
public class CreateClassesForModelImplementationEmpty {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String packageName = CreateClassesForModelImplementationEmpty.class.getPackage().getName()
                .replace("test","");
    ...
    public static void readModelJsonFile(File file) throws FileNotFoundException {
        ...
        // System.out.println(Deneme.class.getProtectionDomain().getCodeSource().getLocation()
        // .toURI().getPath());
        Type elementType = new TypeToken<ModelsGsonType>(){}.getType();
        Gson gson = new Gson();
        /**
         String path = Deneme.class.getProtectionDomain().getCodeSource().getLocation().getPath();
         String decodedPath = URLDecoder.decode(path, "UTF-8");
         System.out.println(decodedPath); */
        //Deneme.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath()
